...
gconf = GeneralConfig()
DATASET_DIR, MODEL_DIR, OLD_MODEL_PATH, EXP_DIR = gconf.DATASET_DIR, gconf.MODEL_DIR, gconf.OLD_MODEL_PATH, gconf.EXP_DIR
...
def main(args):
    config = BulletConfig()
    dataset_train = BulletDataset()
    dataset_train.load_bullet(DATASET_DIR, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = BulletDataset()
    dataset_val.load_bullet(DATASET_DIR, "val")
    dataset_val.prepare()
    ...
    model = modellib.MaskRCNN(mode="training", config=config,
                              model_dir=join(EXP_DIR, "training_logs"))
