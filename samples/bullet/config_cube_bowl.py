...
class GeneralConfig(object):
	...
	DATASET_DIR = '/home/msieb/projects/Mask_RCNN/datasets/bullet'
	OLD_MODEL_PATH = None
	COCO_MODEL_PATH = os.path.join(ROOT_PATH, "mask_rcnn_coco.h5")
	
	WEIGHTS_PATH = "/home/msieb/projects/Mask_RCNN/experiments/cube_and_bowl/logs/bullet20181006T1738/"  # TODO: update this path
	WEIGHTS_FILE = 'mask_rcnn_bullet_0039.h5'
	WEIGHTS_FILE_PATH = join(WEIGHTS_PATH, WEIGHTS_FILE)

	# Mask RCNN config specific and specific for experiment
	CLASS_NAMES = ['cube', 'bowl']
	CLASS_IDS = [i for i in range(1, len(CLASS_NAMES) + 1)]  # ascending indexing starting from 1
	
	# Bullet specific
	BULLET_CLASS_IDS = [5, 4] # To load labels correcty - comes from bullet interface not and MRCNN specific
