...
DATASET_DIR = '/home/msieb/projects/Mask_RCNN/datasets/bottle'
MODEL_DIR = os.path.join('/media/msieb/data/Mask_RCNN', "logs/training")
...
class BaxterConfig(Config):
    ...
    GPU_COUNT = 1
    IMAGES_PER_GPU = 2
    CLASS_NAMES = ['BG', 'bottle', 'mug', 'hand']
    TARGET_IDS = [2]
