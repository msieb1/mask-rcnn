...
DATASET_DIR = '/media/zhouxian/ed854110-6801-4dcd-9acf-c4f904955d71/iccv2019/synthetic_data_generation/iccv2019/synthetic_data'
MODEL_DIR = '/media/zhouxian/ed854110-6801-4dcd-9acf-c4f904955d71/iccv2019/synthetic_data_generation/iccv2019/mask_rcnn_models'
# Import Mask RCNN
...
class BaxterConfig(Config):
    ...
    GPU_COUNT = 1
    IMAGES_PER_GPU = 2
    CLASS_NAMES = ['BG', 'hexagon', 'rings', 'squares', 'mugs', 'pens', 'hand', 'robot']
    ...
    NUM_CLASSES = 1 + 7 # background + 7 objects
