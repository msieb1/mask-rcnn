...
DATASET_DIR = '/home/zhouxian/projects/Mask_RCNN/datasets/baxter_cvpr'
...
class BaxterConfig(Config):
    ...
    GPU_COUNT = 1
    IMAGES_PER_GPU = 2
    CLASS_NAMES = ['BG', 'giraffe', 'hand', 'robot']
    TARGET_IDS = [2]
    # Number of classes (including background)
    NUM_CLASSES = 1 + 3 # background + 3 objects
...
class InferenceConfig(BaxterConfig):
    MODEL_PATH = "/home/zhouxian/projects/Mask_RCNN/weights/baxter20180707T1715/mask_rcnn_baxter_0019.h5"
    GPU_COUNT = 1
    IMAGES_PER_GPU = 1
    CLASS_NAMES = ['BG', 'giraffe', 'hand', 'robot']
    TARGET_IDS = [2]
...
class BaxterDataset(utils.Dataset):
    ...
    def load_baxter(self, dataset_dir, subset):
        ...
        """
        # Add classes
        self.add_class("baxter", 1, "giraffe")
        self.add_class("baxter", 2, "hand")
        self.add_class("baxter", 3, "robot")
